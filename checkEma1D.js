...
const findEmaOverForBuy = async(coinName2, timeRequest)=>{
    ...
    {
        bot.sendMessage(chatId,coinName2 + " ema10 > ema89" + "  "  + timeRequest)
    }
          ...
          // 	var coinName2= "CTKUSDT"
               if(coinName2.includes("USDT"))
                ...
                //       var test30m =  await  updatePriceForBuy(coinName2, "15m")
                   ...
                   var score_buy = 0
                   var test30mbuy =  await  findEmaOverForBuy(coinName2, "1D")
                   var test30mbuy =  await  findEmaOverForBuy(coinName2, "4h")
