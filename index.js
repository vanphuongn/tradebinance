        ...
        if ((ema10[ema10.length - 1] > ema20[ema20.length - 1])
            ...
            try {
                if ((lastest4EmaIsAscendingOrder != -1) && (lastestEma10UnderEma89 != -1)) {
                    ...
                    // console.log("hasLowerEma89 "+hasLowerEma89)
                    ...
                    if (hasLowerEma89 == true) {
                        ...
                        for (var i = 0; i < candleHasLowerEma89Idx - 1; i++) {
                            ...
                            try {
                                ...
                                if ((priceDatas[priceDatas.length - 1 - i].close < priceDatas[priceDatas.length - 1 - i].open)
                                    && (priceDatas[priceDatas.length - 1 - (i + 1)].high > bbResult[resultLength - 1 - (i + 1)].upper)) {
                                    hasHeadFake = true;
                        ...
                        for (var i = 0; i < candleHasHeadFakeIdx; i++) {
                            if ((priceDatas[priceDatas.length - 1 - i].close > priceDatas[priceDatas.length - 1 - (i + 1)].open)
                                ...
                                //console.log("  buy  " + i + "  "+ priceDatas[priceDatas.length-1-i].close)
                                idexForBuy = i
                                  if(idexForBuy < 4)
                                {
                            ...
                            if((rsiValues[rsiValues.length-1-i]>  60) && (rsiValues[rsiValues.length-1-(i+1)]< 60))
                            {
                                idexForBuy = i
                                  if(idexForBuy < 4)
                                {
                                    bot.sendMessage(chatId, coinName2 + "  "+ timeRequest+ "  buy rsi " + idexForBuy + "  " + priceDatas[priceDatas.length - 1 - idexForBuy].close)
                                }
                                console.log(coinName2 + "  "+ timeRequest+ "  buy rsi " + idexForBuy + "  " + priceDatas[priceDatas.length - 1 - idexForBuy].close)
                    ...
                    else if (hasLowerEma89 == false) {
                        // neu tu cay ma 4 duong ema sap xep lan luot den cay gan nhat ema10 < ema89
                        // ko co cay nen nao lower < ema89
                        // waiting
                                    ...
                                    for (var i = 0; i < candleHasHeadFakeIdx; i++) {
                                        if ((ema10[ema10.length - 1 - i] > ema20[ema20.length - 1 - i])
                                            ...
                                            idexForBuy = i;
                                             if(idexForBuy < 4)
                                            {
                                                      console.log(coinName2+ "  "+ timeRequest + "  buy case2 & ema " + idexForBuy + "  " + priceDatas[priceDatas.length - 1 - idexForBuy].close)
                                      
                                                bot.sendMessage(chatId, coinName2+ "  "+ timeRequest + "  buy case2 & ema " + idexForBuy + "  " + priceDatas[priceDatas.length - 1 - idexForBuy].close)
                                            }
                                        ...
                                        if ((macdData2[(macdData2.length - 1 - i)].MACD > macdData2[(macdData2.length - 1 - i)].signal)
                                            ...
                                            idexForBuy = i;
                                              if(idexForBuy < 4)
                                            {
                                                   console.log(coinName2 + "  "+ timeRequest+ "  buy case2 & macd " + idexForBuy + "  " + priceDatas[priceDatas.length - 1 - idexForBuy].close)
                                        
                                                bot.sendMessage(chatId, coinName2 + "  "+ timeRequest+ "  buy case2 & macd " + idexForBuy + "  " + priceDatas[priceDatas.length - 1 - idexForBuy].close)
                                            }
                    ...
                    if (hasHigherEma89 == false) {
                        ...
                        for (var i = 0; i < candleHasHigherEma89Idx - 1; i++) {
                            ...
                            try {
                                // console.log(" i "+ i + "  "+ priceDatas[priceDatas.length - 1 - i].close)
                                if ((priceDatas[priceDatas.length - 1 - i].close > priceDatas[priceDatas.length - 1 - i].open)
                                    && (priceDatas[priceDatas.length - 1 - (i + 1)].low < bbResult[resultLength - 1 - (i + 1)].lower)) {
                                    hasHeadFake = true;
                                    candleHasHeadFakeIdx = i;
                                    // console.log("hasHeadFake + candleHasHeadFakeIdx  " + candleHasHeadFakeIdx)
                                    //  break;
                        ...
                        if(idexForShell < 4)
                        {
                            console.log(coinName2 + "  "+ timeRequest+ "  sell  " + idexForShell + "  " + priceDatas[priceDatas.length - 1 - idexForShell].close)
