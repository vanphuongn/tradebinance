...
//    continue;
    ...
    for(var i =0; i < lastestEma10OverEma89Index; i++)
    {
        ...
        {
            priceMinIndex = i;
          //  console.log("priceMinIndex  "+ priceMinIndex)
            priceAtMinIndex = priceDatas[priceDatas.length-1-i].close;
        }
  ...
  //  && (macdData2[(macdData2.length -2)].MACD < macdData2[(macdData2.length -2)].signal)
    ...
    //    var max1_index = price_max1_arr.indexOf(Math.max( ...price_max1_arr))
       ...
       // console.log(timeRequest+ "  buy pass 0 "+ coinName2+ "  price_max_1 "+ price_max_1 + "   :  max1_index  " + max1_index)
              ...
              //      console.log("Pass 2")
                    {
                        ...
                        if(pt > 0.55){
                            console.log(timeRequest+ " BUY "+ coinName2+ "   : "
      ...
      // for(var coinIndex = 0; coinIndex < top20.length; coinIndex++)
         {
          ...
          //   console.log("coinName  " + coinName2)
        	var coinName2= "DUSKUSDT"
               if(coinName2.includes("USDT") && (coinName2 != "COCOSUSDT"))
                {
                    try{
                     // var test1m = await  findEmaOverForBuy(coinName2, "1m")
                        var test3m = await  findEmaOverForBuy(coinName2, "3m")
