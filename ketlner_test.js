          ...
          //      var ema100 = EMA.calculate({period : 200, values : prices})
            ...
            //   && (Math.abs(macdData2[macdData2.length -1].MACD) < Math.abs(priceDatas[priceDatas.length-1].close*0.006))
               )
               {
                    ...
                    bot.sendMessage(chatId, " macd end tang " +  macdData2[(macdData2.length -1)].MACD+ "  price " + priceDatas[priceDatas.length-1].close + " coinName  "+ coinName2)
                    console.log(" macd end tang " + "  price " + priceDatas[priceDatas.length-1].close+ " coinName  "+ coinName2)
               }
